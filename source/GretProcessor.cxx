...
GretProcessor::GretProcessor()
{
};

vector<float> GretProcessor::Coor_Trans_Gretina ( float R, float theta, float phi, float sphere_split )
{
...
GretProcessor::Gret_Tracking (Gretina_header header, float sphere_split)
{
