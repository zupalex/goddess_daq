...
# For the SuperX3, the offset is ( X: center of detector vs. center of the chamber, Y: distance detector to barrel mount outer radius, Z: start of active area compared to center of chamber)
SuperX3 Offset = (0, 4.78, 4)

# For the QQQ5, the offset is ( X: tip of the QQQ5 arc circle vs. center of the chamber, Y: first strip lower edge to center of the chamber, Z: distance detector to barrel mount end )
QQQ5 Offset = (0, 25.22, -15.75)
