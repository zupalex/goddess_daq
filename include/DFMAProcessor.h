...
struct DecayType_new east;

struct DecayType_new empty;

struct recoil_buffer_type
{

    RecoilType recoil[RBUFFSIZE];
    int head;
    int tail;
    int count;
    int s_fr;
...
void RBuffer_put ( recoil_buffer_type* _this, RecoilType& c )
{
    RecoilType newrecoil = c;
...
void DBuffer_put ( decay_buffer_type* _this, DecayType& c )
{
    DecayType newrecoil = c;
